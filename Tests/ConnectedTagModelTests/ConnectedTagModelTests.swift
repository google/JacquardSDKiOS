...
final class ConnectedTagModelTests: XCTestCase {
  ...
  func testTagComponent() {
    ...
    XCTAssertEqual(component.componentID, DeviceConstants.FixedComponent.tag.rawValue)
    XCTAssertEqual(component.vendor.id, DeviceConstants.vendor)
    XCTAssertEqual(component.vendor.name, DeviceConstants.vendor)
