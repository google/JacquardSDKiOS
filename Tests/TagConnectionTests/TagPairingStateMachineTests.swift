...
final class TagPairingStateMachineTests: XCTestCase {
  ...
  func testVerifyDidConnect() {
    ...
    service.characteristics = [
      commandCharacteristic, responseCharacteristic, notifyCharacteristic, unknownCharacteristic,
    ]
    ...
    peripheral.services = [service, anotherService]
    ...
    awaitingNotificationUpdatesExpectation.expectedFulfillmentCount = 2
  ...
  func testVerifyNotifyStateError() {
    ...
    notifyStateErrorExpectation.expectedFulfillmentCount = 2
    ...
    service.characteristics = [commandCharacteristic, responseCharacteristic, notifyCharacteristic]
    peripheral.services = [service]
