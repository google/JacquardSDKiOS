...
class GestureNotificationSubscriptionTests: XCTestCase {
  ...
  func testCreateSubscriptionRequest() {
    ...
    let _ = GestureNotificationSubscription()
  }
  ...
  func testEmptyNotification() {
    ...
    XCTAssertNil(notification.extract(from: emptyProto) as Any?)
  }
  ...
  func testGoodNotificationForBrushIn() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.brushIn.rawValue)
  }

  func testGoodNotificationForBrushOut() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.brushOut.rawValue)
  }

  func testGoodNotificationForDoubleTap() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.doubleTap.rawValue)
  }

  func testGoodNotificationForNoInference() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.noInference.rawValue)
  }

  func testGoodNotificationForShortCover() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.shortCover.rawValue)
  }

  func testGoodNotificationForNotificationWhite() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.notificationWhite.rawValue)
  }

  func testGoodNotificationForBrushUp() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.brushUp.rawValue)
  }

  func testGoodNotificationForBrushDown() {
    testGoodNotificationProtoContents(expectedGestureID: Gesture.brushDown.rawValue)
  }
