...
class VersionTests: XCTestCase {
  ...
  func testBadFirmwareVersion() {
    XCTAssert(!Version.badFirmwares.isEmpty)
    XCTAssertEqual(Version.badFirmwares[0], Version(major: 1, minor: 68, micro: 0))
    XCTAssertEqual(Version.badFirmwares[0].description, "v1.68.0")
  }
}
