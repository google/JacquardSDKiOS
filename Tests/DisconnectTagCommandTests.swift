...
class DisconnectTagCommandTests: XCTestCase {
  ...
  func testRequestCreation() {
    ...
    guard let request = disconnectTagRequest.request as? Google_Jacquard_Protocol_Request else {
      XCTFail("Unexpected type for the disconnect tag request.")
      return
    }
