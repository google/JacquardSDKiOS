...
public class RedRoundCornerButton: RoundButton {
  ...
  override public func configureColorScheme() {
    disabledBackgroundColor = RedColorScheme.disabledBackgroundColor()
    disabledTitleColor = RedColorScheme.disabledTitleColor()
    buttonScheme.colorScheme = RedColorScheme.colorScheme()
    isUppercaseTitle = false
    setShadowColor(.clear, for: .normal)
  }
