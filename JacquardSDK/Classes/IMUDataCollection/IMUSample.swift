...
public struct IMUSample: Equatable {
  ...
  /// Accelorometer data for the sample.
  ...
  public struct Vector {
    /// X axis data for accelorometer, also corresponds to Roll for gyroscope data.
    public var x: Int16
    /// Y axis data for accelorometer, also corresponds to Pitch for gyroscope data.
    public var y: Int16
    /// Z axis data for accelorometer, also corresponds to Yaw for gyroscope data.
    public var z: Int16
  }
}
