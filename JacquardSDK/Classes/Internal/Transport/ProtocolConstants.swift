...
enum DeviceConstants {
  static let factoryFirmwareVersion = Version(major: 1, minor: 0, micro: 6)
  static let fileSystemCorruptionFixVersion = Version(major: 1, minor: 68, micro: 0)
  static let tileSupportVersion = Version(major: 1, minor: 81, micro: 0)

  static let product = "ujt"
  static let vendor = "google"
...
enum JacquardServices {
  ...
  static let v2Characteristics = [commandUUID, responseUUID, notifyUUID]
}
