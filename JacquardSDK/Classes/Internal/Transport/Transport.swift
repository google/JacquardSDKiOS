...
protocol Transport {
  ...
  var notificationPublisher: AnyPublisher<Data, Never> { get }

  var rawDataPublisher: AnyPublisher<Data, Never> { get }

  var rawDataPacketPublisher: AnyPublisher<Data, Never> { get }
  ...
  var peripheralRSSIPublisher: AnyPublisher<Float, Never> { get set }
