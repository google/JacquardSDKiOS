...
// //TODO(b/201615995): add timeout for discovery phases. No timeout should apply to connection, since connection
...
//   start -> disconnected;
//
//   //TODO(b/201615749): validate characteristic properties (eg. writable)
//
//   "*" -> error
