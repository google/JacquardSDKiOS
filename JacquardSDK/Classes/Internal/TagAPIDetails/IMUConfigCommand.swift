...
struct IMUConfigCommand: CommandRequest {

  let imuConfig: Google_Jacquard_Protocol_ImuConfiguration

  var request: V2ProtocolCommandRequestIDInjectable {
    return Google_Jacquard_Protocol_Request.with {
      $0.domain = .base
      $0.opcode = .configWrite
      $0.Google_Jacquard_Protocol_UJTConfigWriteRequest_configWrite.imuConfig = imuConfig
    }
  }
